 ...
 * 
 */
public class VerticaOutputFormat implements OutputFormat<Text, VerticaRecord> {
  ...
  /**
	...
	/**
	  ...
	  * @param truncateTable
	  */
	public static void setOutput(JobConf job, String tableName, boolean truncateTable) {
  ...
  synchronized Connection getConnection(Configuration configuration) throws IOException {
	...
	@Override
	public org.apache.hadoop.mapred.RecordWriter<Text, VerticaRecord> getRecordWriter(FileSystem fileSystem, JobConf jobConf, String s, Progressable progressable) throws IOException {
		return null;
	}
